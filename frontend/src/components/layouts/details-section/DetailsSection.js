...
const DetailsSection = () => {
    ...
    const handleDownload = () => {
        if (bookData.book_download_url) {
            window.open(bookData.book_download_url, '_blank');
        } else {
            ...
            <div className='container'>
                <div className="flex-container">
                    ...
                    <div className='book-detail-container'>
                        ...
                        <button onClick={handleAddToCart} className="butt-primary">Add To Cart</button>
                        <button className="butt-primary" onClick={handleDownload}>Download PDF</button>
                        </div>
                    </div>
                </div>
            </div>
