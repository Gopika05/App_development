...
const Navbar = ({ darkTheme, darkText }) => {
    ...
    const showLoginandSignUp = (
        <nav className="nav-links-container">
            ...
            <Link to="/videos" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>Videos</Link>
            <Link to="/Edu-books" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>Edu-books</Link>
            <Link to="/about" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>About</Link>
            <Link to="/login" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>Login</Link>
            <Link to="/signup" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>Register</Link>
            <Link to="/adminpage" className={`${darkText ? 'nav-links-dark' : 'nav-links'}`}>Admin</Link>
        </nav>
    )
    ...
    return (
        <section className={ `navbar-container ${ darkTheme ? 'background-dark relative' : 'background-transparent' } ` }>
            <div className="container flex justify-between align-center">
                <Link to="/" className="logo">BOOK <span className="text-primary">HUNT</span></Link>
